...
public class GoldHopper extends BlockWithEntity {
    ...
    public GoldHopper(Settings settings) {
        super(settings);
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, Upgradeables.GOLD_HOPPER_ENTITY, GoldHopperEntity::serverTick);
    }
