...
public class DiamondHopper extends BlockWithEntity {
    ...
    public DiamondHopper(Settings settings) {
        super(settings);
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, Upgradeables.DIAMOND_HOPPER_ENTITY, DiamondHopperEntity::serverTick);
    }
